...
SRC_FILES=main.c parser_token_build.c parser_token_char_utils.c parser_analyse.c parser_modes.c \
		...
		env_print_sort.c cmd_build.c flow_utils.c cmd_utils.c cmd_exec.c cmd_build_utils.c iterate_utils.c \
		cmd_env_utils.c parser_token_debug.c redirect.c func_utils.c signal.c
LIBFT_DIR=libft
