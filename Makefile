...
SRC_FILES=main.c parser_token_build.c parser_token_char_utils.c parser_analyse.c parser_modes.c \
		...
		quote_removal.c token_joining.c parser_conclusion.c builtin_exit.c builtin_unset.c \
		builtin_export.c builtins_common.c env_build.c env_utils.c env_print_sort.c parser_token_debug.c
LIBFT_DIR=libft
